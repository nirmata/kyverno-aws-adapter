...
func (in *AWSAdapterConfigStatus) DeepCopyInto(out *AWSAdapterConfigStatus) {
	*out = *in
	...
	if in.KyvernoPolicyViolations != nil {
		in, out := &in.KyvernoPolicyViolations, &out.KyvernoPolicyViolations
		*out = make([]KyvernoPolicyViolation, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoPolicyViolation) DeepCopyInto(out *KyvernoPolicyViolation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoPolicyViolation.
func (in *KyvernoPolicyViolation) DeepCopy() *KyvernoPolicyViolation {
	if in == nil {
		return nil
	}
	out := new(KyvernoPolicyViolation)
	in.DeepCopyInto(out)
	return out
}
